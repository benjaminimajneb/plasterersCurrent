...
$updateForm.= "
	...
	<div id='newBeerPopup' class='popup'>
		...
		<form> 
			...
			<div> <h4> Pack Cost Price (ex VAT) </h4> <input size='5'></input></div>
			<div> <h4> Unit Cost Price </h4> <input size='5' name='unitCostPrice'></input></div>
			...
			<div> 
				...
				<select name='standardMeasure'>
					<option value='half'> half pint </option>
					<option value='330'> 330ml </option>
					<option value='335'> 335ml </option>
			...
			<div> <h4> Pack volume (keg size, number of bottles etc.) </h4> 
				<select name='packVolume'>
					<option value='9'> 9 gallon cask </option>
					<option value='30'> 30L keg </option>
					<option value='24'> 24 pack </option>
					<option value='12'> 12 pack </option>
					<option value='18'> 18 pack </option>
					<option value='20'> 20L keg </option>
					<option value='4.5'> 4.5 gallon pin </option>
					<option value='50'> 50L keg </option>					
				</select>
			</div>
